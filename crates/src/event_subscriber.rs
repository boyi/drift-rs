...
pub enum DriftEvent {
    OrderFill {
        ...
        maker_order_cumulative_base_filled: Option<u64>,
        taker: Option<Pubkey>,
        taker_fee: u64,
        taker_order_id: u32,
        taker_side: Option<PositionDirection>,
        taker_order_base_asset_amount: Option<u64>,
        taker_order_cumulative_base_filled: Option<u64>,
    ...
    fn from_oar(value: OrderActionRecord, signature: &str, tx_idx: usize) -> Option<Self> {
        match value.action {
            ...
            OrderAction::Fill => Some(DriftEvent::OrderFill {
                ...
                maker_order_base_asset_amount: value.maker_order_base_asset_amount,
                maker_order_cumulative_base_filled: value.maker_order_cumulative_base_asset_amount_filled,
                taker: value.taker,
                taker_fee: value.taker_fee.unwrap_or_default(),
                taker_order_id: value.taker_order_id.unwrap_or_default(),
                taker_side: value.taker_order_direction,
                taker_order_base_asset_amount: value.taker_order_base_asset_amount,
                taker_order_cumulative_base_filled: value.taker_order_cumulative_base_asset_amount_filled,
    ...
    async fn log_stream_handles_jit_proxy_events() {
        ...
        assert_eq!(
            ...
            DriftEvent::OrderFill {
                ...
                ts: 1710893646,
                bit_flags: 0,
                maker_order_base_asset_amount: todo!(),
                maker_order_cumulative_base_filled: todo!(),
                taker_order_base_asset_amount: todo!(),
                taker_order_cumulative_base_filled: todo!()
            }
        );
